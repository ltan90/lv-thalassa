...
2. Copy the new file named .env based on the .env.example file and change the parameters accordingly
3. Run the command to update packages - <b> composer install </b>
4. Run the command: <b> php artisan key: generate </b> - to create the application key
